...
from ..SortUnitStruct import SortUnitStruct
...
def test_basic( cmdline_opts ):
  run_test_vector_sim( SortUnitStruct(), [ header_str,
...
def test_stream( cmdline_opts ):
  run_test_vector_sim( SortUnitStruct(),
...
def test_random( nbits, cmdline_opts ):
  ...
  run_test_vector_sim( SortUnitStruct(nbits),
